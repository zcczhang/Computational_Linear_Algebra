...
plot(-20:-1,diff1, xlab = "10^-x", ylab = "Difference in Log(Error)", main = "Differences in log(error) between forward and backward difference", pch=19, col='steelblue2', ylim = c(-5,5))
points(-20:-1,diff11, pch=19, col='red')

plot(-20:-1,diff2, xlab = "10^-x", ylab = "Difference in Log(Error)", main = "Differences in log(error) between backward and centered difference", pch=19, col='steelblue2', ylim = c(-15,15))
points(-20:-1,diff22, pch=19, col='red')

plot(-20:-1,diff3, xlab = "10^-x", ylab = "Difference in Log(Error)", main = "Differences in log(error) between centered and forward difference",pch=19, col='steelblue2', ylim = c(-15,15) )
