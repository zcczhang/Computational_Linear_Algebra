...
> After around 8 iterations, it will become converge. The convergence order is $1$(linear), and rate is almost $0$.
...
> The convergence order is $1$(linear), and rate is almost $1$. It is different from d) since...
