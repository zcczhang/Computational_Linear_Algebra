...
> After around 8 iterations, it will become converge. The convergence order is $1$(linear), and rate is around $0$.
...
> The convergence order is $1$(linear), and rate is aroun $0.5$. It is different from d) since
