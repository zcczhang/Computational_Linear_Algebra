...
for fraction: $.25*2=.5+0; .5*2=0+1; 0*0=0+0....$ So $(0.25)_{10}=(.010)_{2}$<br>Therefore, $(11.25)_{10}=(1011.010)_{2}$

(b) 2/3  

> for integer: 0<br>for fration: $2/3*2 = 1/3+1, 1/3*2 = 2/3+0, 2/3*2=1/3+1... => (0.\overline{10})_{2}$ <br>So $(11)_{10}$ = $(1011)_{2}$ $(2/3)_{10}=(0.\overline{10})_{2}$


(f) 99.9

> for integer, $99/2=49...1, 49/2=24...1, 24/2=12...0, 12/2=6...0, 6/2=3...0, 3/2=1...1, 1/2=0...1$, so $(99)_{10}$ = $(1100011)_{2}$<br>
for fraction, $0.9*2=.8+1, .8*2=.6+1, .6*2=.2+1, .2*2=.4+0, .4*2=.8+0, .8*2=.6+1......$, so $(0.9)_{10}$ = $(0.1\overline{1100})_{2}$<br>
...
> $(7/3)_{10} = (10.\overline{01})_{2} = 1.0010101010101010101010101010101010101010101010101010*2^{1}$<br> after rounding, $= 1.0010101010101010101010101010101010101010101010101011*2^{1}$<br>
$(4/3)_{10} = (1.\overline{01})_{2}=1.0101010101010101010101010101010101010101010101010101*2^{0} =$<br> $0.1010101010101010101010101010101010101010101010101010*2^{1}$<br><br>
$1.0010101010101010101010101010101010101010101010101011*2^{1} -$<br>
$0.1010101010101010101010101010101010101010101010101010*2^{1} =$<br>
$0.1000000000000000000000000000000000000000000000000001*2^{1}$ (after rounding) $= 1+\epsilon_{mach}$<br><br>
Therefore, $(7/4-3/4)-1=\epsilon_{mach}$, I can determine machine epsilon on a computer using IEEE double precision and the IEEE Rounding to Nearest Rule by calculating (7/3 − 4/3) − 1. 
...
> Because of loss of significance, 
